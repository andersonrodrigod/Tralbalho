...
# Lê os arquivos
antigo = pd.read_excel("Planilha agosto atualizada 10.10 COPIA.xlsx", sheet_name="BASE", dtype=str)
novo = pd.read_excel("Planilha agosto nova.xlsx", sheet_name="BASE", dtype=str)
dados = pd.read_excel("total_agosto_adicionar.xlsx", dtype=str)[["Codigo", "Telefone 2"]].dropna()
